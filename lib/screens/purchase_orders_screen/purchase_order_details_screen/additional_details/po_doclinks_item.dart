...
class PoDoclinkItem extends ConsumerStatefulWidget {
  const PoDoclinkItem({super.key, required this.docLink});

  final Doclink docLink;

  @override
  ConsumerState<PoDoclinkItem> createState() {
    return _PoDoclinkItemState();
  }
}

class _PoDoclinkItemState extends ConsumerState<PoDoclinkItem> {
  String apiKey = '';
