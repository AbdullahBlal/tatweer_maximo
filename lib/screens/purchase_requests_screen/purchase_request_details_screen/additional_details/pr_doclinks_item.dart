...
class PrDoclinkItem extends ConsumerStatefulWidget {
  const PrDoclinkItem({super.key, required this.docLink});

  final Doclink docLink;

  @override
  ConsumerState<PrDoclinkItem> createState() {
    return _PrDoclinkItemState();
  }
}

class _PrDoclinkItemState extends ConsumerState<PrDoclinkItem> {
  String apiKey = '';
